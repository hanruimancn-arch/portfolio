...
const supportingProjects = [
  {
    ...
    sections: [
      { title: '品牌内容', body: '围绕品牌历史、先锋精神与高级制表理念规划品牌向内容，补充单一新品传播之外的品牌叙事，保持不同选题之间统一的品牌调性。' },
      { title: '产品内容', body: '针对新品、复杂功能、机芯结构及设计细节整理产品资料，优先提炼具有辨识度的功能、工艺与设计亮点，再补充专业信息，降低腕表内容的阅读门槛。' },
      { title: '节点内容', body: '结合新品发布、品牌合作及赛车赛事等节点规划选题，将腕表产品与速度、机械性能、赛车文化等内容结合，拓展产品之外的传播切口。' },
      { title: '内容呈现', body: '根据选题筛选产品图、品牌视觉及赛事素材，并结合正文信息层级调整视觉顺序，完成从资料梳理—选题—文案—视觉—发布的内容协同。' },
    ],
  },
  {
    no: '02',
